...
void Rendering::Resources::Transform::SetTransform(const glm::vec3& p_pos, const glm::vec3& p_rot, const glm::vec3& p_scale)
{
	m_pos = p_pos;
	m_rot = p_rot;
	m_scale = p_scale;
...
const glm::mat4& Rendering::Resources::Transform::GetModelMatrix() const noexcept
{
