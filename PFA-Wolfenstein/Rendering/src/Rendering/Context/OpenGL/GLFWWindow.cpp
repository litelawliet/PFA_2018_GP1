...
GLFWWindow::GLFWWindow(const unsigned int p_width, const unsigned int p_height) noexcept : m_width { p_width }, m_height { p_height }
{
	m_glfwWindow = glfwCreateWindow(static_cast<int>(p_width), static_cast<int>(p_height), "Wolfenstein", nullptr, nullptr);
