...
namespace Rendering::Utils
{
    ...
    public:
        ...
        void Invoke(Types ...p_args) const noexcept
        {
        ...
        {
            callback_id id = m_availableListenerId++;
		...
		enum KeyCode
		{
            None = 999, //not assigned to our keyboard (shouldn't be sent as return of a key)
            Backspace = 259,
            Delete = 261,
            Tab = 258,
            Return = 257,
    ...
    private:
        callback_id                               m_availableListenerId{0};
