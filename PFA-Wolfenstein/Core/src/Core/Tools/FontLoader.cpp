...
Core::Tools::FontLoader::FontLoader()
{
	...
	FT_Face face;
	if (FT_New_Face(ft, "../rsc/fonts/arial.ttf", 0, &face))
...
void Core::Tools::FontLoader::RenderText(Rendering::Resources::Shader &s, std::string text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color)
{
